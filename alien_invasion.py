...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        self.stars = [
		    [random.randint(0, self.settings.screen_width),random.randint(0,
                self.settings.screen_height)]
		    for x in range(self.settings.star_count)
	    ]
    ...
    def run_game(self):
        ...
        self.sb.load_high_score() # Load previous high score
        while True:
            self._check_events()
    ...
    def _create_fleet(self):
        ...
        # number_rows = number_rows // 2 # Remove this line for largest fleet
    ...
    def _check_aliens_bottom(self):
        ...
        for alien in self.aliens.sprites():
            if alien.rect.bottom >= screen_rect.bottom:
                # Treat this the same as if thie ship got hit.
                self._ship_hit()
                break
